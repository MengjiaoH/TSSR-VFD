...
class ConvLSTMCell(nn.Module):
    ...
    def forward(self, input_tensor, cur_state):
        ...
        g = torch.tanh(cc_g)
        # print("debug c_cur", c_cur.size())
        # print("debug f size", f.size())
        # print("debug i size", i.size())
        # print("debug g size", g.size())
        c_next = f * c_cur + i * g
        h_next = o * torch.tanh(c_next)

        # print("h_next", h_next.size())
        # print("c_next", c_next.size())

        return h_next, c_next

    def init_hidden(self, batch_size, volume_size):
        height, width, length = volume_size
...
class ConvLSTM(nn.Module):
    ...
    def forward(self, input_tensor, hidden_state=None):
        ...
        for layer_idx in range(self.num_layers):
            ...
            # print("layer hidden state", layer_idx, h.size()) 
            output_inner = []
            ...
            # print("layer output size: ", layer_output.size())
